function tfce_score = limo_tfce_spacetime(varargin)
...
%
% FORMAT tfce_score = limo_tfce(type,data,updatebar,E,H,dh)
%
% INPUT data can be either a map of t/F values or a set of t/F maps computed under H0 (in last dim)
...
elseif nargin == 6
    ...
    error('wrong number of argumwents in')
end
